...
export function hexCol2rgba(hexColor: string, alpha: number = 255): [number, number, number, number];
export function isPowerOf2(n: number): boolean;
export function makeCircleCoords(steps: number, radius: number = 1): Array<number>;
export function maxOf(a: number, b: number): number;
export function pick(names: Array<string>): (obj: Object) => Object;
